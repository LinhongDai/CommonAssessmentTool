...
level_of_schooling = np.random.choice(
    [6, 8, 10, 12, 14], size=num_samples, p=[0.1, 0.25, 0.3, 0.25, 0.1]
)
...
success_rate = (success_rate_base / success_rate_base.max() * 100) + np.random.normal(
    0, 5, num_samples
)
...
print(
    f" {num_samples} diversified synthetic data rows generated and saved to data_commontool_synthetic.csv"
)
